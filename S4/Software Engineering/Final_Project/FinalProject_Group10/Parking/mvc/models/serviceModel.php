...
function addService($serviceName, $serviceDescription) {
    ...
    try {
        // Chuẩn bị câu truy vấn SQL
        $sql = "INSERT INTO service1 (name, description) VALUES (:serviceName, :serviceDescription)";
...
function updateService($serviceId, $serviceName, $serviceDescription) {
    ...
    try {
        ...
        $sql = "UPDATE service1 SET name = :serviceName, description = :serviceDescription WHERE serviceID = :serviceId";
