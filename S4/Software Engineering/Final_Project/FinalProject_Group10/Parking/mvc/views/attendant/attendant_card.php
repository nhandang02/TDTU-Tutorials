...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="attendant.html">
                        ...
                        <div class="card-body">
                            <form id="parkingForm">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cardNumber" placeholder="Enter ID Card" required>
                                </div>
                                <div class="form-group">
